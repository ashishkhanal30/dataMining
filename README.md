...
-   add a short summary image to the README showing a saved cluster map
-   generate scripts to run the notebooks headlessly and export results
-   create a requirements subset for quick experimentation
